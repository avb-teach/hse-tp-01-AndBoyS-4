...
Для отправки решения вам необходимо запушить коммит с вашим решением в свою ветку (ее нужно создать) и сделать пулл реквест. После каждого пулл реквеста вы сможете посмотреть, сколько баллов вы получили (рядом с коммитом будет значок, на него можно нажать)
![alt text](media/image.png)
Пушить напрямую в ветку main у вас не получится
